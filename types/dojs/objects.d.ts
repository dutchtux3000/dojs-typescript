 ...
 * Node addresses are arrays of 6 numbers between 0-255 (e.g. [1, 2, 3, 4, 5, 6]).
 */
type IpcAddress = object;
/**
 * An array with four numbers (e.g. [192.168.1.2]).
 */
type IpAdddress = object;
